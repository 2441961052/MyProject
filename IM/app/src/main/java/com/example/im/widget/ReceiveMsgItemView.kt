...
import kotlinx.android.synthetic.main.view_receivemsg_item_view.view.*
import java.util.*

class ReceiveMsgItemView(context: Context?, attrs: AttributeSet? = null) :
    ...
    private fun updateTime(emMessage: EMMessage, showTime: Boolean) {
        ...
        } else tv_time.visibility = View.GONE
    }

    init {
        View.inflate(context, R.layout.view_receivemsg_item_view, this)
    }
}